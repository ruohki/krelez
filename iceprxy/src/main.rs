...
mod tests {
    ...
    #[test]
    fn test_parse_vorbis_metadata() {
        let test_data = [
            ,
        ];

        let result = parse_vorbis_metadata(&test_data[1..]);  // Skip the first byte as we're testing without packet type
        assert!(result.is_some());
        
        let metadata = result.unwrap();
        assert_eq!(metadata.artist.as_deref(), Some("Virt"));
        assert_eq!(metadata.title, "My favorite thing");
    }
}
